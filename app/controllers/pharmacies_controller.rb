class PharmaciesController < ApplicationController
  ...
  private
    ...
    def pharmacy_params
      params.require(:pharmacy).permit(:patient_id, :integer, :patient_name, :gender, :string, :age, :string, :email, :string, :phone_number, :string, :delivery_address, :string, :prescription_medicines, :delivery_details, :string)
    end
end
